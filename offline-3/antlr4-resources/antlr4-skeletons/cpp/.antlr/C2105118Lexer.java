...
public class C2105118Lexer extends Lexer {
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 33:
			...
			break;
		case 34:
			UNRECOGNIZED_CHAR_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	...
	private void HASH_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 34:
			 writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <HASH> Lexeme " + getText()); 
			break;
		}
	}
	private void UNRECOGNIZED_CHAR_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 35:
